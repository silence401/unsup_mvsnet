...
parser.add_argument('--lrepochs', type=str, default="4,8,10,12:2", help='epoch ids to downscale lr and the downscale rate')
...
parser.add_argument('--smooth_lambda', type=float, default=1.0, help="smooth weight")
